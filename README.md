...
- Build Command: `pip install -r requirements.txt`
- Start Command: `uvicorn BotForge.dashboard_app:app --host 0.0.0.0 --port $PORT`
...
- Build Command: `pip install -r requirements.txt`
- Worker Start Command: `python BotForge/main.py`
- Web Start Command: `uvicorn BotForge.dashboard_app:app --host 0.0.0.0 --port $PORT`
